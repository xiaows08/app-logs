window._zhugeSdk = function(t) {
    ...
    0: function(t, e) {
        var n, i, o, r, s, a, c, u, d, p, l, h = window.navigator, f = window.document, g = h.userAgent, m = Array.prototype, v = Object.prototype, _ = v.toString, y = m.forEach, w = Array.isArray, k = m.slice, b = v.hasOwnProperty, S = {}, T = {
            each: function(t, e, n) {
                if (null != t)
                    if (y && t.forEach === y)
                        t.forEach(e, n);
                        ...
                        for (var r in t)
                            if (b.call(t, r) && e.call(n, t[r], r, t) === S)
                                return
            },
            extend: function(t) {
                ...
                var e = function(t) {
                    ...
                    switch (p && "object" == typeof p && "function" == typeof p.toJSON && (p = p.toJSON(t)),
                        ...
                        case "object":
                            ...
                            for (s in p)
                                b.call(p, s) && (a = n(s, p)) && d.push(e(s) + (o ? ": " : ":") + a);
                            return a = 0 === d.length ? "{}" : o ? "{" + d.join(",") + u + "}" : "{" + d.join(",") + "}",
                                o = u,
                                a
                    }
                };
            ...
            cookie: {
                ...
                set: function(t, e, n, i, o) {
                    var r = ""
                        ...
                        , a = "";
                    if (i) {
                        var c = f.location.hostname.match(/[a-z0-9][a-z0-9\-]+\.[a-z\.]{2,6}$/i)
                            , u = c ? c[0] : "";
                        r = u ? "; domain=." + u : ""
                    }
                    if (n) {
                    ...
                    o && (a = "; secure"),
                        f.cookie = t + "=" + encodeURIComponent(e) + s + "; path=/" + r + a
                },
                remove: function(t) {
                    var e = f.location.hostname.match(/[a-z0-9][a-z0-9\-]+\.[a-z\.]{2,6}$/i)
                        , n = e ? e[0] : "";
                    T.cookie.set(t, "", -1, "." + n)
                }
            },
            ...
            addStyleRules: function(t) {
                ...
                for (var i = 0, o = t.length; i < o; i++) {
                    var r = 1
                        ...
                        , a = t[i][0]
                        , c = "";
                    "[object Array]" === Object.prototype.toString.call(s[1][0]) && (s = s[1],
                        r = 0);
    ...
    6: function(t, e, n) {
        var i = n(0)
            ...
            bind: function(t, e, n, o) {
                ...
                var r = function(e) {
                    if ((e.target = e.target || e.srcElement,
                        i.isFunction(n)) && !1 === n.call(o, e || window.event, t))
                ...
                if (t.addEventListener)
                    ...
                    var s = "on" + e
                        , a = t[s];
                    t[s] = function(e) {
                        return i.isFunction(a) && a.call(t, e || window.event),
            ...
            isClickAble: function(t, e, n) {
                ...
                switch (o) {
                    ...
                    case "button":
                        ...
                        break;
                    case "input":
                        /button|reset|submit/.test(r) && !t.disabled && (a.flag = !0,
                        "submit" === r && (a.form = t.form));
                        break;
                    case "body":
                        a.flag = !1;
                        break;
            ...
            getSelector: function(t) {
                for (var e = this.getAttr(t, "id"), n = this.getTagName(t), o = i.trim(this.getAttr(t, "class")).split(/\s/), r = [], s = 0, a = o.length; s < a; s++)
                    new RegExp(this.prefix.interface + "|" + this.prefix.expand).test(o[s]) || r.push(o[s]);
                return r = r.join("."),
                    e ? "#" + e : n + (r = r ? "." + r : "")
            },
    ...
    70: function(t, e, n) {
        ...
        s.prototype = {
            ...
            _onMessage: function(t) {
                var e = t.origin
                    , n = t.data;
                if ("https://zhugeio.com" === e)
                    switch (n.command) {
                        case "pageReload":
                            window.sessionStorage.removeItem("zhugeAnalysisModeType"),
                                n.href ? location.replace(n.href) : location.reload();
                            break;
                        case "openJsHeatMap":
        ...
        a.prototype = {
            ...
            _init: function() {
                o.ready(function() {
                    this._initEventBind(),
                        this._loadEventList(),
                    window.sessionStorage.getItem(s.SESSION_KEYS.IS_ANALYSIS_MODE) && this._loadAnalysisCode()
                }, this)
            },
            _initEventBind: function() {
                o.bind(window, "message", this._onMessage, this)
                ...
                if ("https://zhugeio.com" === e)
                    switch (n.command) {
                        case "openJsVisualizer":
                            ...
                            break;
                        case "getQueryParam":
                            window.sessionStorage.setItem(s.SESSION_KEYS.PARAMS, JSON.stringify(n.data)),
                                this._loadAnalysisCode()
                    }
            },
            _loadAnalysisCode: function() {
                if (!this.loaded) {
                    this.loaded = !0,
                        ...
                        window.sessionStorage.setItem(s.SESSION_KEYS.IS_ANALYSIS_MODE, JSON.stringify({
                            flag: !0
                        }));
            ...
            _onMessage: function(t) {
                if ("https://zhugeio.com" === t.origin) {
                    ...
                    switch (e.command) {
                        case "pageReload":
                            window.sessionStorage.removeItem("zhugeAnalysisModeType"),
                                e.href ? location.replace(e.href) : location.reload();
                            break;
                        case "authorized":
    ...
    73: function(t, e, n) {
        ...
        h.prototype._init = function(t, e, n) {
            if (this._key = t,
                ...
                ,
                i.isObject(e))
                for (var o in i.extend(this.config, e),
                    this.config)
                    i.isObject(this.config[o]) && (this.config[o] = i.JSONEncode(this.config[o]));
            var r = this
                , s = function(t, e) {
                r._initDid(t),
                    r.cookie = new u("zg_" + r._key,r.config);
                var n = i.cookie.get("_zg");
                n && r.config.inherit_user_data ? (r.cookie.register_once(i.JSONDecode(n), ""),
                    i.cookie.remove("_zg")) : r.cookie.register_once({
                    sid: 0,
                    updated: 0,
                    info: 0,
            ...
            this.config.adTrack ? (r._wrapTrackerFunction(),
                i.jsonp("https://u.zhugeapi.net/v2/zgadtrack/header", function(t) {
                    s(t.zg_adver_did, t.zg_adver_sid),
                        n(),
                        r._doTrackerQueue()
                }, function() {
                    s(),
            ...
            h.prototype._initLanding = function() {
                var t = this
                    , e = function(e) {
                    t.config.autoTrack && (l && clearTimeout(l),
                ...
                t.config.zgsee && o("https://ubak.zhugeio.com/appkey/" + this.getKey(), {
                    ...
                    success: function(e) {
                        if (0 === e.policy || -1 === e.policy) {
                            ...
                            c.loadJs({
                                src: "https://zgsdk.zhugeio.com/zgsee.min.js?r=" + r
                            })
                        }
                    },
                    error: function(t) {
            ...
            h.prototype._initAutoTrack = function() {
                var t = !0
                    ...
                    if (t) {
                        ...
                        if (s.flag) {
                            var a = [];
                            o.config.autoTrack && !i.hasMobileSdk().flag && a.push(n.getEvent(s)),
                            o.config.visualizer && (a = e.getEvent(s).concat(a));
                            var u = r.target || r.srcElement || {}
                                , d = u.clickedByZgSdk
                                , p = c.getAttr(s.target, "target");
                            if (o.config.redirectAfterTrack && document.body.addEventListener && (!p || "_self" === p))
                                return !0 === d || !a.length || (o.batchTrack(a, function() {
                                    u.clickedByZgSdk = !0,
                                        u.click()
                                }),
                                    !1);
            ...
            h.prototype._session = function(t) {
                ...
                if (0 == o || r > n + 60 * this.config.session_interval_mins * 1e3) {
                    if (o > 0 && n > 0) {
                        ...
                        a.pr.$ct = n,
                            a.pr.$tz = 6e4 * -s.getTimezoneOffset(),
                            a.pr.$dru = n - o,
                            a.pr.$sid = o,
                            a.pr.$cuid = this.cookie.props.cuid,
                            this.cookie.register({
                                zs: 0,
                                sc: 0
                            }),
                    ...
                    c.pr = i.extend(c.pr, u),
                        ...
                        c.pr.$tz = 6e4 * -s.getTimezoneOffset(),
            ...
            h.prototype._info = function(t) {
                ...
                if (n > e + 24 * this.config.info_upload_interval_days * 60 * 60 * 1e3 || t) {
                    ...
                    o.pr.$tz = 6e4 * -r.getTimezoneOffset(),
                        ...
                        o.pr = i.extend(o.pr, i.encode(i.JSONDecode(this.cookie.props.platform))),
                    1 === this.cookie.props.zs && (o.pr.$zs = 1),
                        this._batchTrack(o),
                        this.cookie.register({
                            info: n
                        }, "")
            ...
            h.prototype.identify = function(t, e, n) {
                ...
                if (s.flag)
                    ...
                    a.pr.$ct = c.getTime(),
                        ...
                        a.pr = i.extend(a.pr, i.encode(o)),
                        this._batchTrack(a, r)
                }
            }
            ,
            ...
            h.prototype.track = function(t, e, n) {
                var o = i.isObject(e) ? e : {}
                    ...
                    , s = i.hasMobileSdk();
                s.flag ? (s.track(t, o),
                i.isFunction(r) && r()) : this.batchTrack([{
                    dt: "evt",
                    eid: t,
                    param: o
                }], r)
            ...
            h.prototype.batchTrack = function(t, e) {
                ...
                for (var n = [], o = new Date, r = this.cookie.props.utm ? i.JSONDecode(this.cookie.props.utm) : {}, s = 0, a = t.length; s < a; s++) {
                    ...
                    if (c && c.dt) {
                        ...
                        for (var d in u.pr.$ct = o.getTime(),
                            u.pr.$tz = 6e4 * -o.getTimezoneOffset(),
                            u.pr.$cuid = this.cookie.props.cuid,
                            u.pr.$sid = this.cookie.props.sid,
                            u.pr.$url = location.href,
            ...
            h.prototype._initDid = function(t) {
                ...
                i.cookie.get("zg_did") || i.cookie.remove("zg_" + this._key),
                    this.did = new u("zg_did",this.config),
